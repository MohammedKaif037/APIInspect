...
import { RequestData, ResponseData, Environment, Collection, AuthConfig, MockConfig, Test, RequestHistory } from "@/lib/types";
import { processUrl, processHeaders, processParams, processBody } from "@/lib/environment-utils";
...
export default function Home() {
  ...
  const handleSendRequest = async (requestData: RequestData) => {
    ...
    try {
      ...
      // Prepare headers
      const headerEntries = processedHeaders
